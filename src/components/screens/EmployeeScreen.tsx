  ...
  return (
    <div className="h-full flex flex-col gap-4">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 border border-phosphor p-3 bg-crt-black/30 min-w-0">
            <h2 className="text-xl text-phosphor text-glow-bright mb-1 border-b border-phosphor-dark pb-1">
              ══════ EMPLOYEE RECORD ══════
            </h2>
        ...
        <div className="flex-1 flex flex-col lg:flex-row gap-4 min-h-0">
          {/* Bio Section */}
          <div className="flex-1 min-w-[300px] border border-phosphor bg-crt-black/30 flex flex-col min-h-[280px] lg:min-h-[320px]">
